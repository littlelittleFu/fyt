...
七、红黑树
0、特性：插入、删除效率高时间复杂度为O(N)  旋转3次即可 相比于AVL(不确定旋转次数)
1、特点
①结点是红色或者黑色
②根是黑色的
③所有的叶子是黑色的
...
不满足特性需要变色、旋转
①父节点红色，uncle节点不是红色(无uncle节点)
RR：父节点为grand右节点，当前节点是父节点的右节点
LL：父节点为grand左节点，当前节点是父节点的左节点
修复：parent染黑，grand染红
RR：祖父左旋，父节点充当对接节点
LL：祖父右旋，父节点充当对接节点

RL：父节点为grand右节点，当前节点是父节点左节点
LR：父节点为grand左节点，当前节点是父节点右节点
修复：插入节点染黑，grand染红
RL：父节点右旋，grand左旋，当前节点充当对接点
LR：父节点左旋，grand右旋，当前节点充当对接点
父节点红色，uncle节点红色：上溢
